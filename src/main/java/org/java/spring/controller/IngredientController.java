...
public class IngredientController {
	...
	public String index(Model model ) {
		...
		return getIngredients(ingredients , "Lista ingredienti" , "ingredient/index" , model);
	}
	...
	public String store(@Valid @ModelAttribute("ingredient") Ingredient ingredient , BindingResult br , Model model) {
		return saveInDb(ingredient, br , "ingredient/create" ,  "redirect:/ingredients/" , "Creazione offerta" , "Aggiungi alla lista l'offerta" , model);
	}
	...
	public String trash(Model model ) {
		...
		return getIngredients(ingredients , "Lista offerte cestinate" , "ingredient/trash" , model);
	}
